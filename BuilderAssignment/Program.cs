...
namespace BuilderAssignment
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            IRamenBuilder misoBuilder = new MisoRamenBuilder();
            IRamenBuilder spicyBuilder = new SpicyRamenBuilder();
            IRamenBuilder veganBuilder = new VeganRamenBuilder();
            // TODO#3: Use your RamenChef to prepare (build) each type of ramen (Miso, Spicy, Vegan)
            ramenChef.PrepareRamen(misoBuilder);
            ramenChef.PrepareRamen(spicyBuilder);
            ramenChef.PrepareRamen(veganBuilder);
            ...
            Console.WriteLine(misoBuilder.GetRamen().FinishedBowlOfRamen());
            Console.WriteLine(spicyBuilder.GetRamen().FinishedBowlOfRamen());
            Console.WriteLine(veganBuilder.GetRamen().FinishedBowlOfRamen());
        }
    }
}